...
hierRecOld <- function (dset, h=1, fmethod="ets", iTest=1, 
  ...
  calibration50 <- NA#checkCalibration(h, preds, sigma, test, coverage = 0.5)
  calibration80 <- NA#checkCalibration(h,  preds, sigma, test, coverage = 0.8)
  ...
  mseBayesDiag =  mean  ( (allts(test)[h,] - bayesRecon(preds, residuals, mSumMatrix, covariance="diagonal", sigma=sigma))^2 )
  mseBayesGlasso =  mean  ( (allts(test)[h,] - bayesRecon(preds, residuals, mSumMatrix, covariance="glasso", sigma=sigma))^2 )
  mseBayesShr =  mean  ( (allts(test)[h,] - bayesRecon(preds, residuals, mSumMatrix, covariance="shr", sigma=sigma))^2 )
  mseBayesSample =  mean  ( (allts(test)[h,] - bayesRecon(preds, residuals, mSumMatrix, covariance="sam", sigma=sigma))^2 )
